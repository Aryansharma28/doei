export const translations = {
  nl: {
    ...
    aiActionItems: "Actiepunten", aiSummary: "Samenvatting",
    ...
    profile: "Profiel",
    profileName: "Naam",
    profileNamePh: "Uw volledige naam",
    profileEmail: "E-mailadres",
    profilePhone: "Telefoonnummer",
    saveChanges: "Wijzigingen opslaan",
    integrations: "Koppelingen",
    integrationsSub: "Koppel accounts om schuldinformatie automatisch te importeren",
    dueThisWeek: "deze week", askAdvisorCta: "Vraag de adviseur wat te doen",
    clearFilter: "Filter wissen", noResults: "Geen resultaten",
    gmailDesc: "Importeer schuld-gerelateerde e-mails automatisch",
    bankAccount: "Bankrekening",
    bankDesc: "Synchroniseer betalingstransacties",
    digiDDesc: "Verifieer uw identiteit bij overheidsinstanties",
    connected: "Gekoppeld",
  ...
  en: {
    ...
    aiActionItems: "Action Items", aiSummary: "Summary",
    ...
    integrationsSub: "Link accounts to automatically import debt-related information",
    dueThisWeek: "this week", askAdvisorCta: "Ask the advisor what to do",
    clearFilter: "Clear filter", noResults: "No results",
    gmailDesc: "Auto-import debt-related emails",
    bankAccount: "Bank Account",
    bankDesc: "Sync payment transactions",
    digiDDesc: "Verify your identity with government bodies",
    connected: "Connected",
