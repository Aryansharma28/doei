...
export const S = {
  ...
  heroCard: { background: "linear-gradient(135deg, #3D405B 0%, #2A2D42 100%)", borderRadius: 20, padding: "28px 24px 22px", color: "white", marginBottom: 16, boxShadow: "0 8px 32px rgba(42,45,66,0.28), 0 2px 8px rgba(42,45,66,0.16)" },
  ...
  debtCard: { display: "flex", alignItems: "center", gap: 14, background: "var(--card-bg)", borderRadius: 14, padding: 16, marginBottom: 10, border: "1px solid var(--border-color)", borderLeft: "3px solid var(--border-color)", cursor: "pointer", width: "100%", textAlign: "left", boxShadow: "0 1px 3px rgba(0,0,0,0.05)" },
